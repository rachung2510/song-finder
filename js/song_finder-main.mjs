...
var t$1 = { 2: (t22) => {
...
}, 101: function(t22, e2, n2) {
  var r2;
  t22 = n2.nmd(t22), (function() {
    var o2 = (t22 && t22.exports, "object" == typeof global && global);
  ...
  var r2 = n2(2);
  t22.exports = function(t3) {
    return t3 ? ("{}" === t3.substr(0, 2) && (t3 = "\\{\\}" + t3.substr(2)), m2((function(t42) {
      return t42.split("\\\\").join(o2).split("\\{").join(i2).split("\\}").join(s2).split("\\,").join(a2).split("\\.").join(u2);
    })(t3), true).map(c2)) : [];
  };
  ...
  function m2(t3, e3) {
    ...
    if (/\$$/.test(o3.pre)) for (var u3 = 0; u3 < a3.length; u3++) {
      ...
      else if (1 === (y2 = h2(o3.body)).length && 1 === (y2 = m2(y2[0], false).map(p2)).length) return a3.map((function(t42) {
        return o3.pre + y2[0] + t42;
      }));
      if (x2) {
  ...
  !(function() {
    ...
    s2._ff = function(t3, e4, n3, r3, o3, i3, s3) {
      ...
      return (a2 << i3 | a2 >>> 32 - i3) + e4;
    }, s2._blocksize = 16, s2._digestsize = 16, t22.exports = function(t3, n3) {
  ...
  function y2(t3, e3, n3) {
    ...
    n3 && (x2.query = n3(x2.query)), i3 && e3.slashes && "/" !== x2.pathname.charAt(0) && ("" !== x2.pathname || "" !== e3.pathname) && (x2.pathname = (function(t42, e4) {
      if ("" === t42) return e4;
      for (var n4 = (e4 || "/").split("/").slice(0, -1).concat(t42.split("/")), r3 = n4.length, o3 = n4[r3 - 1], i4 = false, s3 = 0; r3--; ) "." === n4[r3] ? n4.splice(r3, 1) : ".." === n4[r3] ? (n4.splice(r3, 1), s3++) : s3 && (0 === r3 && (i4 = true), n4.splice(r3, 1), s3--);
  ...
  } }, y2.extractProtocol = m2, y2.location = d2, y2.trimLeft = h2, y2.qs = o2, t22.exports = y2;
}, 800: () => {
}, 805: () => {
}, 829: (t22) => {
  function e2(t3) {
  ...
  function n2(t3) {
    ...
    return n2 = function(t42) {
      ...
      function s3() {
        return r2(t42, arguments, i2(this).constructor);
      }
      return s3.prototype = Object.create(t42.prototype, { constructor: { value: s3, enumerable: false, writable: true, configurable: true } }), o2(s3, t42);
    }, n2(t3);
  }
  function r2(t3, e3, n3) {
    return r2 = (function() {
      ...
      var r3 = [null];
      r3.push.apply(r3, e4);
      var i3 = new (Function.bind.apply(t42, r3))();
      return n4 && o2(i3, n4.prototype), i3;
    }, r2.apply(null, arguments);
  }
  function o2(t3, e3) {
    return o2 = Object.setPrototypeOf || function(t42, e4) {
      return t42.__proto__ = e4, t42;
    }, o2(t3, e3);
  }
  function i2(t3) {
    return i2 = Object.setPrototypeOf ? Object.getPrototypeOf : function(t42) {
  ...
  var s2 = (function(t3) {
    function n3(t42) {
      ...
      })(this, i2(n3).call(this, t42))).name = "ObjectPrototypeMutationError", r3;
    }
    return (function(t42, e3) {
      if ("function" != typeof e3 && null !== e3) throw new TypeError("Super expression must either be null or a function");
      t42.prototype = Object.create(e3 && e3.prototype, { constructor: { value: t42, writable: true, configurable: true } }), e3 && o2(t42, e3);
    })(n3, t3), n3;
  })(n2(Error));
  function a2(t3, n3) {
  ...
  t22.exports = { set: function(t3, n3, r3) {
    ...
    try {
      return a2(t3, n3, (function(t42, e3, n4, o3) {
        if (t42 === Reflect.getPrototypeOf({})) throw new s2("Attempting to mutate Object.prototype");
        if (!t42[e3]) {
          var i3 = Number.isInteger(Number(n4[o3 + 1])), a3 = "+" === n4[o3 + 1];
          t42[e3] = i3 || a3 ? [] : {};
        }
        return u2(n4, o3) && (t42[e3] = r3), t42[e3];
      }));
    } catch (e3) {
    ...
    try {
      ...
      return a2(t3, n3, (function(t42, e3, n4, i3) {
        if (!u2(n4, i3)) return t42 && t42[e3];
        o3 = r3.own ? t42.hasOwnProperty(e3) : e3 in t42;
      })), o3;
    } catch (t42) {
      return false;
    }
    ...
    try {
      ...
      return a2(t3, n3, (function(t42, n4, o4, a3) {
        return i3 = i3 || t42 === r3 || !!t42 && t42[n4] === r3, s3 = u2(o4, a3) && "object" === e2(t42) && n4 in t42, t42 && t42[n4];
...
function n$2(r2) {
  ...
  return t$1[r2].call(i2.exports, i2, i2.exports, n$2), i2.loaded = true, i2.exports;
}
n$2.n = (t22) => {
...
var x$1 = n$2(101);
n$2.n(x$1);
const A$1 = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : "undefined" != typeof window ? window : globalThis;
A$1.fetch.bind(A$1);
(function(t22) {
...
const et$1 = (t22) => {
  ...
  t: for (; i2 < t22.length; ) {
    ...
    if ("!" !== e3 && "^" !== e3 || i2 !== n2 + 1) {
      ...
      if (s2 = true, "\\" !== e3 || u2) {
        if ("[" === e3 && !u2) {
          for (const [e4, [s3, u3, l3]] of Object.entries(nt$1)) if (t22.startsWith(e4, i2)) {
            if (h2) return ["$.", false, t22.length - n2, true];
            i2 += e4.length, l3 ? o2.push(s3) : r2.push(s3), a2 = a2 || u3;
            continue t;
          }
        }
        u2 = false, h2 ? (e3 > h2 ? r2.push(rt$1(h2) + "-" + rt$1(e3)) : e3 === h2 && r2.push(rt$1(e3)), h2 = "", i2++) : t22.startsWith("-]", i2 + 1) ? (r2.push(rt$1(e3 + "-")), i2 += 2) : t22.startsWith("-", i2 + 1) ? (h2 = e3, i2 += 2) : (r2.push(rt$1(e3)), i2++);
      } else u2 = true, i2++;
    } else l2 = true, i2++;
  }
  if (c2 < i2) return ["", false, 0, false];
  if (!r2.length && !o2.length) return ["$.", false, t22.length - n2, true];
  if (0 === o2.length && 1 === r2.length && /^\\?.$/.test(r2[0]) && !l2) {
    return [(p2 = 2 === r2[0].length ? r2[0].slice(-1) : r2[0], p2.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&")), false, c2 - n2, false];
  }
  var p2;
  const f2 = "[" + (l2 ? "^" : "") + ot$1(r2) + "]", d2 = "[" + (l2 ? "" : "^") + ot$1(o2) + "]";
...
}, at$1 = /* @__PURE__ */ new Set(["!", "?", "+", "*", "@"]), ut$1 = (t22) => at$1.has(t22), lt$1 = "(?!\\.)", ct$1 = /* @__PURE__ */ new Set(["[", "."]), ht$1 = /* @__PURE__ */ new Set(["..", "."]), pt$1 = new Set("().*{}+?[]^$\\!"), ft$1 = "[^/]", dt$1 = ft$1 + "*?", gt$2 = ft$1 + "+?";
let mt$1 = class mt {
  type;
  #t;
  #e;
  ...
  constructor(t22, e2) {
    ...
    this.type = t22, t22 && (this.#e = true), this.#o = e2, this.#t = this.#o ? this.#o.#t : this, this.#u = this.#t === this ? n2 : this.#t.#u, this.#s = this.#t === this ? [] : this.#t.#s, "!" !== t22 || this.#t.#a || this.#s.push(this), this.#i = this.#o ? this.#o.#r.length : 0;
  }
  get hasMagic() {
  ...
  #h() {
    ...
    let t22;
    for (this.toString(), this.#a = true; t22 = this.#s.pop(); ) {
      if ("!" !== t22.type) continue;
      let e2 = t22, n2 = e2.#o;
      for (; n2; ) {
        for (let r2 = e2.#i + 1; !n2.type && r2 < n2.#r.length; r2++) for (const e3 of t22.#r) {
  ...
  toJSON() {
    ...
    return this.isStart() && !this.type && t22.unshift([]), this.isEnd() && (this === this.#t || this.#t.#a && "!" === this.#o?.type) && t22.push({}), t22;
  }
  isStart() {
  ...
  isEnd() {
    ...
    const t22 = this.#o ? this.#o.#r.length : 0;
    return this.#i === t22 - 1;
  }
  copyIn(t22) {
  ...
  clone(t22) {
    const e2 = new mt(this.type, t22);
    for (const t3 of this.#r) e2.copyIn(t3);
    return e2;
  }
  static #p(t22, e2, n2, r2) {
    ...
    if (null === e2.type) {
      ...
      for (; u3 < t22.length; ) {
        ...
        else if ("[" !== n3) if (r2.noext || !ut$1(n3) || "(" !== t22.charAt(u3)) l3 += n3;
        else {
          e2.push(l3), l3 = "";
          const o3 = new mt(n3, e2);
          u3 = mt.#p(t22, o3, u3, r2), e2.push(o3);
        }
    ...
    for (; u2 < t22.length; ) {
      ...
      else if ("[" !== n3) if (ut$1(n3) && "(" === t22.charAt(u2)) {
        l2.push(h2), h2 = "";
        const e3 = new mt(n3, l2);
        l2.push(e3), u2 = mt.#p(t22, e3, u2, r2);
      } else if ("|" !== n3) {
  ...
  static fromGlob(t22) {
    ...
    return mt.#p(t22, n2, 0, e2), n2;
  }
  toMMPattern() {
    if (this !== this.#t) return this.#t.toMMPattern();
    const t22 = this.toString(), [e2, n2, r2, o2] = this.toRegExpSource();
    if (!(r2 || this.#e || this.#u.nocase && !this.#u.nocaseMagicOnly && t22.toUpperCase() !== t22.toLowerCase())) return n2;
    const i2 = (this.#u.nocase ? "i" : "") + (o2 ? "u" : "");
    return Object.assign(new RegExp(`^${e2}$`, i2), { _src: e2, _glob: t22 });
  }
  get options() {
    return this.#u;
  }
  toRegExpSource(t22) {
    const e2 = t22 ?? !!this.#u.dot;
    if (this.#t === this && this.#h(), !this.type) {
      const n3 = this.isStart() && this.isEnd(), r3 = this.#r.map(((e3) => {
        const [r4, o4, i4, s3] = "string" == typeof e3 ? mt.#f(e3, this.#e, n3) : e3.toRegExpSource(t22);
        return this.#e = this.#e || i4, this.#n = this.#n || s3, r4;
      })).join("");
      let o3 = "";
      if (this.isStart() && "string" == typeof this.#r[0] && (1 !== this.#r.length || !ht$1.has(this.#r[0]))) {
        const n4 = ct$1, i4 = e2 && n4.has(r3.charAt(0)) || r3.startsWith("\\.") && n4.has(r3.charAt(2)) || r3.startsWith("\\.\\.") && n4.has(r3.charAt(4)), s3 = !e2 && !t22 && n4.has(r3.charAt(0));
        o3 = i4 ? "(?!(?:^|/)\\.\\.?(?:$|/))" : s3 ? lt$1 : "";
      }
      let i3 = "";
      return this.isEnd() && this.#t.#a && "!" === this.#o?.type && (i3 = "(?:$|\\/)"), [o3 + r3 + i3, st$1(r3), this.#e = !!this.#e, this.#n];
    }
    const n2 = "*" === this.type || "+" === this.type, r2 = "!" === this.type ? "(?:(?!(?:" : "(?:";
    let o2 = this.#d(e2);
    if (this.isStart() && this.isEnd() && !o2 && "!" !== this.type) {
      const t3 = this.toString();
      return this.#r = [t3], this.type = null, this.#e = void 0, [t3, st$1(this.toString()), false, false];
    }
    let i2 = !n2 || t22 || e2 ? "" : this.#d(true);
    i2 === o2 && (i2 = ""), i2 && (o2 = `(?:${o2})(?:${i2})*?`);
    let s2 = "";
    return s2 = "!" === this.type && this.#c ? (this.isStart() && !e2 ? lt$1 : "") + gt$2 : r2 + o2 + ("!" === this.type ? "))" + (!this.isStart() || e2 || t22 ? "" : lt$1) + dt$1 + ")" : "@" === this.type ? ")" : "?" === this.type ? ")?" : "+" === this.type && i2 ? ")" : "*" === this.type && i2 ? ")?" : `)${this.type}`), [s2, st$1(o2), this.#e = !!this.#e, this.#n];
  }
  #d(t22) {
    return this.#r.map(((e2) => {
      if ("string" == typeof e2) throw new Error("string type in extglob ast??");
      const [n2, r2, o2, i2] = e2.toRegExpSource(t22);
  ...
  static #f(t22, e2) {
    ...
    for (let s2 = 0; s2 < t22.length; s2++) {
      const a2 = t22.charAt(s2);
      if (r2) r2 = false, o2 += (pt$1.has(a2) ? "\\" : "") + a2;
      else if ("\\" !== a2) {
        if ("[" === a2) {
          const [n3, r3, a3, u2] = it$1(t22, s2);
          if (a3) {
            o2 += n3, i2 = i2 || r3, s2 += a3 - 1, e2 = e2 || u2;
            continue;
          }
        }
        "*" !== a2 ? "?" !== a2 ? o2 += a2.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&") : (o2 += ft$1, e2 = true) : (o2 += n2 && "*" === t22 ? gt$2 : dt$1, e2 = true);
      } else s2 === t22.length - 1 ? o2 += "\\\\" : r2 = true;
    }
    return [o2, st$1(t22), !!e2, i2];
  }
};
const yt = function(t22, e2) {
  let n2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
  return et$1(e2), !(!n2.nocomment && "#" === e2.charAt(0)) && new Wt(e2, n2).match(t22);
}, vt = /^\*+([^+@!?\*\[\(]*)$/, bt = (t22) => (e2) => !e2.startsWith(".") && e2.endsWith(t22), wt$1 = (t22) => (e2) => e2.endsWith(t22), xt = (t22) => (t22 = t22.toLowerCase(), (e2) => !e2.startsWith(".") && e2.toLowerCase().endsWith(t22)), Et = (t22) => (t22 = t22.toLowerCase(), (e2) => e2.toLowerCase().endsWith(t22)), Nt = /^\*+\.\*+$/, Pt = (t22) => !t22.startsWith(".") && t22.includes("."), At = (t22) => "." !== t22 && ".." !== t22 && t22.includes("."), Tt = /^\.\*+$/, Ot = (t22) => "." !== t22 && ".." !== t22 && t22.startsWith("."), St = /^\*+$/, jt = (t22) => 0 !== t22.length && !t22.startsWith("."), It = (t22) => 0 !== t22.length && "." !== t22 && ".." !== t22, $t = /^\?+([^+@!?\*\[\(]*)?$/, Ct = (t22) => {
  let [e2, n2 = ""] = t22;
  const r2 = Lt([e2]);
...
}, Ut = "object" == typeof process$1 && process$1 ? "object" == typeof define_process_env_default$1 && define_process_env_default$1 && define_process_env_default$1.__MINIMATCH_TESTING_PLATFORM__ || process$1.platform : "posix";
yt.sep = "win32" === Ut ? "\\" : "/";
const Dt = /* @__PURE__ */ Symbol("globstar **");
yt.GLOBSTAR = Dt, yt.filter = function(t22) {
  let e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  return (n2) => yt(n2, t22, e2);
};
const Ft = function(t22) {
  let e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  return Object.assign({}, t22, e2);
};
yt.defaults = (t22) => {
  if (!t22 || "object" != typeof t22 || !Object.keys(t22).length) return yt;
  const e2 = yt;
  return Object.assign((function(n2, r2) {
    return e2(n2, r2, Ft(t22, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}));
  }), { Minimatch: class extends e2.Minimatch {
    constructor(e3) {
      super(e3, Ft(t22, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}));
    }
    static defaults(n2) {
      return e2.defaults(Ft(t22, n2)).Minimatch;
    }
  }, AST: class extends e2.AST {
    constructor(e3, n2) {
      super(e3, n2, Ft(t22, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}));
    }
    static fromGlob(n2) {
      let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return e2.AST.fromGlob(n2, Ft(t22, r2));
    }
  }, unescape: function(n2) {
    let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    return e2.unescape(n2, Ft(t22, r2));
  }, escape: function(n2) {
    let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    return e2.escape(n2, Ft(t22, r2));
  }, filter: function(n2) {
    let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    return e2.filter(n2, Ft(t22, r2));
  }, defaults: (n2) => e2.defaults(Ft(t22, n2)), makeRe: function(n2) {
    let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    return e2.makeRe(n2, Ft(t22, r2));
  }, braceExpand: function(n2) {
    let r2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    return e2.braceExpand(n2, Ft(t22, r2));
  }, match: function(n2, r2) {
    let o2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
    return e2.match(n2, r2, Ft(t22, o2));
  }, sep: e2.sep, GLOBSTAR: Dt });
};
const Vt = function(t22) {
  let e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  return et$1(t22), e2.nobrace || !/\{(?:(?!\{).)*\}/.test(t22) ? [t22] : tt$2(t22);
};
yt.braceExpand = Vt, yt.makeRe = function(t22) {
  return new Wt(t22, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).makeRe();
}, yt.match = function(t22, e2) {
...
class Wt {
    ...
    do {
      ...
      for (let n2 of t22) {
        ...
        for (; -1 !== (o2 = n2.indexOf("..", o2 + 1)); ) {
          ...
          if (t3 && "." !== t3 && ".." !== t3 && "**" !== t3) {
            e2 = true;
            const t42 = 1 === o2 && "**" === n2[o2 + 1] ? ["."] : [];
            n2.splice(o2 - 1, 2, ...t42), 0 === n2.length && n2.push(""), o2 -= 2;
          }
        }
      }
    } while (e2);
  ...
  partsMatch(t22, e2) {
    ...
    for (; r2 < t22.length && o2 < e2.length; ) if (t22[r2] === e2[o2]) i2.push("b" === s2 ? e2[o2] : t22[r2]), r2++, o2++;
    else if (n2 && "**" === t22[r2] && e2[o2] === t22[r2 + 1]) i2.push(t22[r2]), r2++;
    else if (n2 && "**" === e2[o2] && t22[r2] === e2[o2 + 1]) i2.push(e2[o2]), o2++;
    else if ("*" !== t22[r2] || !e2[o2] || !this.options.dot && e2[o2].startsWith(".") || "**" === e2[o2]) {
      if ("*" !== e2[o2] || !t22[r2] || !this.options.dot && t22[r2].startsWith(".") || "**" === t22[r2]) return false;
      if ("a" === s2) return false;
      s2 = "b", i2.push(e2[o2]), r2++, o2++;
    } else {
      if ("b" === s2) return false;
      s2 = "a", i2.push(t22[r2]), r2++, o2++;
    }
    return t22.length === e2.length && i2;
  }
  parseNegate() {
  ...
  matchOne(t22, e2) {
    ...
    if (this.isWindows) {
      const n3 = "string" == typeof t22[0] && /^[a-z]:$/i.test(t22[0]), r3 = !n3 && "" === t22[0] && "" === t22[1] && "?" === t22[2] && /^[a-z]:$/i.test(t22[3]), o3 = "string" == typeof e2[0] && /^[a-z]:$/i.test(e2[0]), i3 = r3 ? 3 : n3 ? 0 : void 0, s3 = !o3 && "" === e2[0] && "" === e2[1] && "?" === e2[2] && "string" == typeof e2[3] && /^[a-z]:$/i.test(e2[3]) ? 3 : o3 ? 0 : void 0;
      if ("number" == typeof i3 && "number" == typeof s3) {
        const [n4, r4] = [t22[i3], e2[s3]];
        n4.toLowerCase() === r4.toLowerCase() && (e2[s3] = n4, s3 > i3 ? e2 = e2.slice(s3) : i3 > s3 && (t22 = t22.slice(i3)));
      }
    }
    const { optimizationLevel: o2 = 1 } = this.options;
    o2 >= 2 && (t22 = this.levelTwoFileOptimize(t22)), this.debug("matchOne", this, { file: t22, pattern: e2 }), this.debug("matchOne", t22.length, e2.length);
    for (var i2 = 0, s2 = 0, a2 = t22.length, u2 = e2.length; i2 < a2 && s2 < u2; i2++, s2++) {
      this.debug("matchOne loop");
      var l2 = e2[s2], c2 = t22[i2];
      if (this.debug(e2, l2, c2), false === l2) return false;
      if (l2 === Dt) {
        this.debug("GLOBSTAR", [e2, l2, c2]);
        var h2 = i2, p2 = s2 + 1;
        if (p2 === u2) {
          for (this.debug("** at the end"); i2 < a2; i2++) if ("." === t22[i2] || ".." === t22[i2] || !r2.dot && "." === t22[i2].charAt(0)) return false;
          return true;
        }
        for (; h2 < a2; ) {
          var f2 = t22[h2];
          if (this.debug("\nglobstar while", t22, h2, e2, p2, f2), this.matchOne(t22.slice(h2), e2.slice(p2), n2)) return this.debug("globstar found match!", h2, a2, f2), true;
          if ("." === f2 || ".." === f2 || !r2.dot && "." === f2.charAt(0)) {
            this.debug("dot detected!", t22, h2, e2, p2);
            break;
          }
          this.debug("globstar swallow a segment, and continue"), h2++;
        }
        return !(!n2 || (this.debug("\n>>> no match, partial?", t22, h2, e2, p2), h2 !== a2));
      }
      let o3;
    ...
    if (i2 === a2) return n2;
    if (s2 === u2) return i2 === a2 - 1 && "" === t22[i2];
    throw new Error("wtf?");
  }
  braceExpand() {
  ...
  parse(t22) {
    ...
    if ("" === t22) return "";
    let n2, r2 = null;
    (n2 = t22.match(St)) ? r2 = e2.dot ? It : jt : (n2 = t22.match(vt)) ? r2 = (e2.nocase ? e2.dot ? Et : xt : e2.dot ? wt$1 : bt)(n2[1]) : (n2 = t22.match($t)) ? r2 = (e2.nocase ? e2.dot ? Rt : Ct : e2.dot ? kt : Mt)(n2) : (n2 = t22.match(Nt)) ? r2 = e2.dot ? At : Pt : (n2 = t22.match(Tt)) && (r2 = Ot);
    const o2 = mt$1.fromGlob(t22, this.options).toMMPattern();
  ...
  makeRe() {
    ...
    let o2 = t22.map(((t3) => {
      const e3 = t3.map(((t42) => {
        ...
        return "string" == typeof t42 ? t42.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&") : t42 === Dt ? Dt : t42._src;
      }));
      return e3.forEach(((t42, r3) => {
        const o3 = e3[r3 + 1], i3 = e3[r3 - 1];
        t42 === Dt && i3 !== Dt && (void 0 === i3 ? void 0 !== o3 && o3 !== Dt ? e3[r3 + 1] = "(?:\\/|" + n2 + "\\/)?" + o3 : e3[r3] = n2 : void 0 === o3 ? e3[r3 - 1] = i3 + "(?:\\/|" + n2 + ")?" : o3 !== Dt && (e3[r3 - 1] = i3 + "(?:\\/|\\/" + n2 + "\\/)" + o3, e3[r3 + 1] = Dt));
      })), e3.filter(((t42) => t42 !== Dt)).join("/");
    })).join("|");
    const [i2, s2] = t22.length > 1 ? ["(?:", ")"] : ["", ""];
  ...
  static defaults(t22) {
    return yt.defaults(t22).Minimatch;
  }
}
yt.AST = mt$1, yt.Minimatch = Wt, yt.escape = function(t22) {
  let { windowsPathsNoEscape: e2 = false } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  return e2 ? t22.replace(/[?*()[\]]/g, "[$&]") : t22.replace(/[?*()[\]\\]/g, "\\$&");
}, yt.unescape = st$1;
var qe = n$2(829);
n$2.n(qe);
var Ze$1 = (function(t22) {
  ...
  (function(exports$1) {
    ...
    (function(exports$12) {
      ...
      Buffer3.compare = function compare(a2, b2) {
        ...
        let x2 = a2.length;
        let y2 = b2.length;
        for (let i3 = 0, len2 = Math.min(x2, y2); i3 < len2; ++i3) {
          if (a2[i3] !== b2[i3]) {
            x2 = a2[i3];
            y2 = b2[i3];
            break;
...
function mt2(e2, t3, o2, i2, s2, r2) {
...
const ee = /* @__PURE__ */ B(dt, [["render", mt2]]), te = {
  methods: {
    show(...e2) {
...
function showInfo(text2, options) {
  return showMessage(text2, {
    ...options,
    type: "toast-info"
    /* INFO */
...
function showSuccess(text2, options) {
  return showMessage(text2, {
    ...options,
    type: "toast-success"
    /* SUCCESS */
...
console.log("Song Finder main.ts loaded");
...
function watchJob(path) {
  const timer = window.setInterval(async () => {
    try {
      const status = await getStatus(path);
      if (status.running) {
        showInfo("Song Finder is still running...");
      } else {
        window.clearInterval(timer);
        showSuccess("Song Finder complete");
      }
    } catch (e2) {
      window.clearInterval(timer);
...
registerFileAction(new FileAction({
  ...
  enabled: (nodes) => {
    return nodes.length === 1 && nodes[0].type === "folder" && (nodes[0].permissions & Permission.READ) !== 0;
  },
  exec: async (node) => {
    try {
      await cancelableClient.post(generateUrl("/apps/song_finder/start"), {
        path: node.path
      });
      watchJob(node.path);
      return true;
